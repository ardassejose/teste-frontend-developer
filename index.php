...
<body>
  ...
  <div class="container-fluid headline">
    <div class="row pt-1 pb-5">
      <div class="col-lg-8 pt-2 pb-5 mx-auto my-auto animate__animated animate__backInLeft">
        <!-- Headline -->
      ...
      <div class="col-lg-4">
        <!-- Formulário -->
        <div class="container-fluid mt-5 animate__animated animate__backInRight animate__delay-1s">
  ...
  <div class="container-fluid bg-white">
    <div class="container-fluid quemSomos pt-5 pb-5">
      <div class="row">
        <div class="col-md-6 my-auto animate__animated animate__pulse animate__infinite" align="center">
          <img height="250" src="assets/img/profile-pic.png" alt="Foto Quem Somos">
        </div>
        <div class="col-md-6 pb-3 my-auto container">
          <div class="w-100 quemSomos-txt">
            <h2>Quem somos?</h2>
  ...
  <div class="container-fluid beneficios pt-5 pb-5">
    ...
    <!-- CTA -->
    <div class="pt-4">
      <a href="#" class="CTA btn btn-lg animate__animated animate__pulse animate__infinite">Faça seu orçamento!</a>
    </div>
    <!-- Fim CTA -->
  </div>
  </div>
        ...
        <div class="col-md-6 my-auto">
          <div class="container mt-sm-5">
            <div class="box">
              ...
              <button class="animate__animated animate__pulse animate__infinite"><a href="#formPrincipal">Preencher formulário</a></button>
